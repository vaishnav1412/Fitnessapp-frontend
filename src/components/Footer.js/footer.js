...
const Footer = () => {
  return (
    <div>
      ...
      <footer class="w-full py-5 bg-black">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto align-middle">
                <a href="#" class="flex justify-center h-15 w-50 ">
                    <img className='' src={logo}/>
                </a>
                    <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-6 mb-5 border-b border-gray-200">
                        <li><a href="#" class=" text-white hover:text-red-600 border-b-2 border-black hover:border-red-600">Contact Us</a></li>
                        <li><a href="#" class=" text-white hover:text-red-600 border-b-2 border-black hover:border-red-600">Products</a></li>
                        <li><a href="#" class=" text-white hover:text-red-600 border-b-2 border-black hover:border-red-600">Resources</a></li>
                        <li><a href="#" class=" text-white hover:text-red-600 border-b-2 border-black hover:border-red-600">Blogs</a></li>
                        <li><a href="#" class=" text-white hover:text-red-600 border-b-2 border-black hover:border-red-600">Support</a></li>
                    </ul>
                    <div class="flex space-x-10 justify-center items-center mb-7">
                    ...
                    <span class="text-lg text-gray-500 text-center block">©pagedone 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>
